...
var TripDetailPage = (function () {
    function TripDetailPage(httpClient, nav, tripService, navParams, loadingCtrl, toastCtrl) {
    ...
    TripDetailPage.prototype.getData = function () {
        var _this = this;
        this.httpClient.get('http://localhost:3000/services/getAll').subscribe(function (res) {
            _this.services = res;
            console.log();
        });
    };
    TripDetailPage.prototype.send = function (service) {
        var _this = this;
        var headers = { headers: new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]({ 'Content-Type': 'application/json' }) };
        this.httpClient
            ...
            "__v": 0
        }), headers).subscribe(function (res) {
            res;
...
TripDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-trip-detail',template:/*ion-inline-start:"C:\Users\KUNTZB\Downloads\ionic3-start-theme-master - Copie\src\pages\trip-detail\trip-detail.html"*/'<!-- -->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>\n      <span ion-text>Services available</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="common-bg">\n\n\n  <!--booking form-->\n  <div *ngFor="let service of services">\n\n    <div *ngIf="service.is_booked && !service.is_accepted && service.price!=\'0\'">\n\n      <div class="booking-form card round" margin>\n        <div class="border-bottom" padding>\n          <h5>{{service.name}}</h5>\n\n          <!--choose guest-->\n          <ion-grid class="filters" no-padding margin-top>\n            <ion-row>\n              <ion-col class="adult" width-70>\n                <span ion-text color="primary"><strong>75 $</strong> </span>\n              </ion-col>\n\n            </ion-row>\n\n          </ion-grid>\n        </div>\n        <!--description-->\n        <div class="border-bottom" padding>\n          <span ion-text color="primary" class="bold">DESCRIPTION</span>\n          <p ion-text>{{service.description}}</p>\n        </div>\n\n        <!--address-->\n        <div class="border-bottom" padding>\n          <span ion-text color="primary" class="bold">LOCATION</span>\n          <p ion-text>Porte de Versailles - Parc des Expositions, 75015 Paris </p>\n        </div>\n        <div padding class="form-bottom">\n          <!--       <span ion-text color="dark" class="bold">{{ adults }} Adults</span> -->\n          <!--booking button-->\n          <button ion-button class="pull-right" color="secondary" tappable (click)="send(service)">Validate\n          </button>\n          <div class="clear"></div>\n        </div>\n      </div>\n\n    </div>\n  </div>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\KUNTZB\Downloads\ionic3-start-theme-master - Copie\src\pages\trip-detail\trip-detail.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__services_trip_service__["a" /* TripService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ToastController */]])
], TripDetailPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_activity_service__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_trip_service__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_weather__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__app_component__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_settings_settings__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_checkout_trip_checkout_trip__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_home_home__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_login_login__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_notifications_notifications__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_register_register__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_search_location_search_location__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_trip_detail_trip_detail__ = __webpack_require__(107);
...
var TRIPS = [
    {
        ...
        highlights: [
            ...
            "Option to opt to be washed by hand",
    ...
    },
    {
        ...
        electric_voucher: 1,
        sub_name: "English Commentary Tour",
        thumb: "assets/img/trip/thumb/car.png",
        description: "From sexy Ipanema and Copacabana, to more secluded and slightly lesser-known stretches of sand, like Prainha Beach, Brazil's Rio de Janeiro is best known for its beaches. Grab your sunscreen and Brazilian bikinis and head to the sunny shores of Rio's best beaches.",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_trip_service__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__trip_detail_trip_detail__ = __webpack_require__(107);
...
var TripsPage = (function () {
    function TripsPage(nav, tripService, httpClient) {
        this.nav = nav;
        this.tripService = tripService;
        this.httpClient = httpClient;
        // set sample data
    ...
    TripsPage.prototype.doSearch = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_3__trip_detail_trip_detail__["a" /* TripDetailPage */]);
        console.log("ok");
    };
    // view trip detail
    TripsPage.prototype.viewDetail = function (service) {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_3__trip_detail_trip_detail__["a" /* TripDetailPage */], { service: service });
    };
    TripsPage.prototype.getData = function () {
        var _this = this;
        this.httpClient.get('http://localhost:3000/services/getAll').subscribe(function (res) {
            _this.services = res;
        });
...
TripsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-trips',template:/*ion-inline-start:"C:\Users\KUNTZB\Downloads\ionic3-start-theme-master - Copie\src\pages\trips\trips.html"*/'<!-- -->\n<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      <span ion-text>Services</span>\n    </ion-title>\n  </ion-navbar>\n\n\n</ion-header>\n\n<ion-content padding class="trips detail-bg">\n\n  <p>Some services are available : Click on this button to discover them :</p>\n\n  <button ion-button icon-start block no-margin color="primary" class="round" tappable (click)="doSearch()">Click</button>\n</ion-content>\n'/*ion-inline-end:"C:\Users\KUNTZB\Downloads\ionic3-start-theme-master - Copie\src\pages\trips\trips.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__services_trip_service__["a" /* TripService */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["a" /* HttpClient */]])
], TripsPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_weather__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__search_location_search_location__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__trip_detail_trip_detail__ = __webpack_require__(107);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    ...
    HomePage.prototype.doSearch = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_6__trip_detail_trip_detail__["a" /* TripDetailPage */]);
        console.log("ok");
    };
    // choose place
...
var TripService = (function () {
    ...
    TripService.prototype.getData = function () {
        var _this = this;
        this.httpClient.get('localhost:3000/services/getAll').subscribe(function (res) {
            _this.posts = res;
            console.log(res);
        });
    };
    TripService.prototype.getAllServices = function () {
